...
public class pressPolygonButtonActionListener extends AbstractAction
{
    private MainFrameModel model;
    public pressPolygonButtonActionListener(MainFrameModel model)
    {
        this.model = model;
    }
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        model.setType(GShape.TYPE.POLY);
