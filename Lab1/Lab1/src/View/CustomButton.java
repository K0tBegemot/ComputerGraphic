...
public class CustomButton extends JButton {
    ...
    private class pressCustomMenuItem extends AbstractAction
    {
        CustomMenuItem item;
        pressCustomMenuItem(CustomMenuItem item)
        {
            this.item = item;
        }
    ...
    public void setCustomMenuItem(CustomMenuItem item)
    {
        addActionListener(new pressCustomMenuItem(item));
    }
}
